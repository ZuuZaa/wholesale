...
params.append('SessionId', session_id);
    ...
    let removeCart= async (event) => {
        ...
        var remove_btn=event.currentTarget;
          try {
            const res = await fetch("https://api.wscshop.co.uk/api/cart/remove-from-cart", {
              ...
              {
                document.getElementById("cart_table").innerHTML="<p class='custom-container mx-auto'>This cart is empty!</p>"
      ...
      let handleClick=async (event)=>{
        ...
        try {
            const res = await fetch("https://api.wscshop.co.uk/api/checkout/checkout", {
              method: "POST",
              headers: {
                'Accept': 'application/json, text/plain',
                'Content-Type': 'application/json;charset=UTF-8',
                ...
                <div className='custom-container mx-auto'>
                    ...
                    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <div className="flex items-center">
                            <a href="#" className="ms-1 text-sm font-medium md:ms-2">Your Shopping Cart</a>
                        </div>
                        </li>
            ...
            {carts.length>0?(
                ...
                <div className='cart-table mb-20'>
                                ...
                                carts.map(cart=>{
                                    return(
                                        <tr>
                                            ...
                                            <td><CounterInput initialValue={cart.quantity} min={1} max={100} id={cart.productId} /> </td>
                    ...
                    <div className='cart-table-btns max-[992px]:block flex justify-end gap-2 pb-8'>
                        ...
                        <Link href='/' className=" link-design1 font-bold inline-flex rounded-full gap-1">Continue Shopping</Link>
                        <Link href='javascript:void(0)' className=" link-design1 font-bold inline-flex rounded-full gap-1" onClick={clearCart}>Clear Cart</Link>
                    </div>
                </div>
                    ...
                    <div className='grid max-[992px]:grid-cols-1 grid-cols-2'>
                        ...
                        <div className='cart-totals-grid-item cart-totals-grid-item-2 px-4'>
                            <div className='cart-totals-area'>
                                    ...
                                    <h2 className='text-4xl mb-10 text-center'>Cart Totals</h2>
                                    ...
                                    <table className='w-full mb-8'>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className='text-sm text-end' id="total">£{subtotal.toFixed(2)}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    {/* <span className='flex pl-5'>  
                                        ...
                                        <Link href='javascript:void(0)' className=" link-design1 font-bold inline-flex rounded-full gap-1 mt-4" onClick={handleClick}>Checkout</Link>
