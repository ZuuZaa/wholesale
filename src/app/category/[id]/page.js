          ...
          <div className="frd-container mx-auto">
            <div className="category-page-grid block lg:flex">
              <div className="category-filters w-full lg:w-1/4 px-4 lg:pr-8">
                ...
                <div className="cf-categories-list">
                  {mainCategory.map((cat) => {
                    return (
                      <div class="active">
                        <Link href="">
                          <h3 className="hover-red text-lg font-semibold capitalize">
                            {cat.name}
                          </h3>
                        </Link>
                        <div className="pl-6">
                ...
                {/* Clear All */}
                <button className="cf-clear-all-btn hover-red-bg flex justify-center gap-2 w-full font-bold text-base">
                  <UilTrashAlt size="22" color="#333" /> CLEAR ALL
                </button>
