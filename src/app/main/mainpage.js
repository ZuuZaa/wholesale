...
import Banner1Bck1 from '../../../public/images/banner/banner1-1.webp';
import Banner1Bck2 from '../../../public/images/banner/banner1-2.webp';
...
async function fetchData(){
  ...
  params.append('SessionId', session_id);
    ...
    const response=await fetch(`https://api.wscshop.co.uk/api/home/get-index?${params.toString()}`,{
      method: "GET",
      headers: {
