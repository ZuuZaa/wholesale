...
const mainFunc=async () => {
    ...
    const fetchData = async () => {
        ...
        let response=await fetch(`https://api.wscshop.co.uk/api/favorites/get-index`,{
            method: 'GET',
            dataType: 'json',
            headers: {
    ...
    try {
      ...
      //if (res.status === 200) {
        ...
        if(resJson.output.favorites.length==0){
            console.log("empty")
            document.getElementById("favorites_div").innerHTML="<p>There is no favorite product!</p>"
        }
        //setMessage("Added");
      }
      //}
    ...
    return (
              ...
              <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                  <div className="flex items-center">
                    <span className="ms-1 text-sm font-medium md:ms-2">Wishlist</span>
                  </div>
                </li>
              </ol>
            </div>
        ...
        <section className='wishlist-main-section mt-5 pt-16'>
          <div className='custom-container mx-auto' id="favorites_div">
                        ...
                        return(
                            ...
                            <div className='wishlist-wrapper-item-content pt-5 mt-1 px-3'>
                                ...
                                <div className='name text-center my-2'>
                                    <Link href='' className='hover-red text-lg'>{product.name}</Link>
                                </div>
            ...
            </div>):(<p>There is no favorite product!</p>)}
