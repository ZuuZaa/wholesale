    ...
    <main>
      {
        contactPage==1?(<div>
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                  ...
                  <li>
                    <div className="flex items-center">
                      <a href="#" className="ms-1 text-sm font-medium text-gray-700  md:ms-2 dark:text-gray-400">Contact</a>
                    </div>
                  </li>
          ...
          <section className='contact-info-section mt-5'>
            <div className='custom-container mx-auto'>
              <div>
                <h1 className='text-center md:text-left text-xl md:text-4xl font-bold'>We're always eager to hear from you!</h1>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 mt-11 gap-2">
                        ...
                        <div className="flex mb-3 lg:mb-0">
                          ...
                          <div className='content'>
                              ...
                              <ul>
                                <li>Mobile: <b>{set.phone}</b></li>
                                <li>Whatsapp: <b>{set.whatsappNo}</b></li>
                                <li>Email: <b>{set.email}</b></li>
                              </ul>
                          </div>
                        </div>
                        <div className="flex mb-3 lg:mb-0">
          ...
          <section className='contact-map-section'>
              <div className='custom-container mx-auto'>
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1244.8769438889544!2d-0.1448854016051989!3d51.389201199999974!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4876062f7b172457%3A0x8b818ac37b5c336e!2sWSC%20-Wholesale%20Packaging%20and%20Cleaning%20Products%20Supplier!5e0!3m2!1sen!2str!4v1714057269657!5m2!1sen!2str" width="600" height="450" style={{border:0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
          </section>
